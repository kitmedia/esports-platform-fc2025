      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12">
        ...
        <div className="mt-10 text-center">
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} EA SPORTS FC 2025 eSports Platform. All rights reserved.
          </p>
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400 mt-2">
            Not affiliated with EA SPORTS. This is an independent tournament platform.
          </p>
        </div>
      </div>
    </footer>
